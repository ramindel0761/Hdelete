...
api.sendKeyboard(msg.chat.id, '  را در گروه شما ادد کنیم حالا روی دکمه زیر کلیک کنید @Sphero منتظر ما باشید تا به گروه شما بیایم و ربات'  ,do_keyboard_endchat(), true)
end
